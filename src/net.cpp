...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Insuracoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"insuraco.in", "107.170.90.194"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"insuracointools.com", "testnet-seed.insuracointools.com"},   //Need to fix testnetdnssseed stuff
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Insuracoin is probably already running."), addrBind.ToString().c_str());
        else
